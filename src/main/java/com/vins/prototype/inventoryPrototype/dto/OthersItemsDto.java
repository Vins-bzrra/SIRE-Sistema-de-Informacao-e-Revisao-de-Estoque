...
public class OthersItemsDto {
    ...
    public OthersItemsDto() {
		super();
	}
	
	public OthersItemsDto(String brand, String model, String patrimony, Date acquisitionDate, String supplier,
			String unitLocation, String status, double purchasePrice, String currentOwner, String category,
			String description, String processNumber, String material, String dimensions, String color,
